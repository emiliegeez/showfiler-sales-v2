...
from showfiler_sales.settings import TEMPLATE_DIR
...
class ContactForm(forms.Form):
    ...
    subject_template_name = TEMPLATE_DIR + '/contact_form_subject.txt'

    template_name = TEMPLATE_DIR + '/contact_form.txt'
